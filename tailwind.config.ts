  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        kenburns:  { '0%': { transform: 'scale(1.08) translate(-1%, -1%)' }, '100%': { transform: 'scale(1.18) translate(1%, 1%)' } },
        drift:     { '0%,100%': { transform: 'translate3d(0,0,0)' }, '50%': { transform: 'translate3d(3%, -4%, 0)' } },
        driftAlt:  { '0%,100%': { transform: 'translate3d(0,0,0)' }, '50%': { transform: 'translate3d(-4%, 3%, 0)' } },
        flicker:   { '0%,100%': { opacity: '0.85', filter: 'blur(40px)' }, '47%': { opacity: '1', filter: 'blur(48px)' }, '53%': { opacity: '0.7', filter: 'blur(36px)' } },
        slowPulse: { '0%,100%': { opacity: '0.55' }, '50%': { opacity: '0.9' } },
      },
      animation: {
        ...
        slowPulse: 'slowPulse 9s ease-in-out infinite',
      },
    },
  },
  plugins: [],
